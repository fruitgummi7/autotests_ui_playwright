from components.views.image_upload_widget_component import ImageUploadToolbarViewComponent
...
class CreateCoursePage(BasePage):
    def __init__(self, page: Page):
        ...
        self.image_upload_widget = ImageUploadToolbarViewComponent(page, 'create-course-preview')
